    ...
    <div className={styles['kontakte-container']} ref={containerRef}>
      ...
      <div className={styles.header}>
        ...
        >
          ...
          <div className={styles['small-text']} onClick={() => window.scrollTo({ top: 3500, behavior: 'smooth' })} style={{ cursor: 'pointer' }}>About</div>
          <div className={styles['small-text']} onClick={() => window.scrollTo({ top: 6500, behavior: 'smooth' })} style={{ cursor: 'pointer' }}>Newsletter</div>
        </div>
